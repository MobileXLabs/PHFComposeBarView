...
CGFloat const kTextContainerCornerRadius  = 6.15f;
...
- (UIToolbar *)backgroundView {
    if (!_backgroundView) {
        ...
        [_backgroundView setTranslucent:NO];
...
- (UIButton *)textContainer {
    if (!_textContainer) {
        ...
        _textContainer.layer.cornerRadius = kTextContainerCornerRadius;
        _textContainer.layer.masksToBounds = YES;
